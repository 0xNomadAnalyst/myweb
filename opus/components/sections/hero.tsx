    ...
    <SectionShell variant="hero">
      <FadeIn>
        <div className="max-w-2xl">
          ...
          <p className="body-measure mt-4 text-sm leading-relaxed text-muted-foreground/84">
          ...
          <p className="text-sm text-muted-foreground/66">
          ...
          <div className="mt-8">
            ...
            <a
              href="#"
              className="mt-4 block text-sm text-muted-foreground/72 hover:text-muted-foreground/92"
            >
              Watch 3-minute platform overview&ensp;&rarr;
            </a>
            <a
              href="#"
              className="mt-2.5 block font-mono text-xs text-muted-foreground/64 hover:text-muted-foreground/78"
            >
      ...
      <FadeIn delay={0.2}>
        <div className="mt-10 flex flex-wrap gap-2">
          {domains.map((domain) => (
            <span
              key={domain}
              className="rounded-lg border border-border bg-secondary/72 px-2.5 py-1 font-mono text-[11px] text-muted-foreground/80"
            >
              {domain}
            </span>
          ))}
