  ...
  return (
    <SectionShell id="approach">
      ...
      <div className="mt-10 grid gap-4 md:grid-cols-3">
        {principles.map((item, i) => (
          <FadeIn key={item.title} delay={i * 0.09}>
            <div className="card-interactive rounded-lg border border-border bg-card p-5">
      ...
      <FadeIn delay={0.1}>
        ...
        <p className="mt-3 max-w-[640px] text-sm leading-relaxed text-muted-foreground/90">
