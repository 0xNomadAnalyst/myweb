...
export function SystemDiagram() {
  return (
    <FadeIn delay={0.15}>
      <div className="mt-10 rounded-lg border border-border/40 bg-card/30 px-4 pb-5 pt-5 md:px-8 md:pb-7 md:pt-6">
        ...
        >
          ...
          {/* belongs to: Obligations group → Market Account */}
          ...
          {/* positions: each obligation → reserves area */}
